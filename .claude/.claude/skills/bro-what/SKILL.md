...
Bro, what? That did not land. Diagnose why, then re-pitch it in the shape that fixes it: a **pitch** for a buried idea, a **rundown** for buried status.

## Pitch

Plain prose, ASD-STE100 Simplified Technical English, opening on the idea rather than an apology. Buy clarity with simpler words, not more of them — swap an abstraction for a concrete example.
...
Tag an unavoidable term in five words or fewer. Asked to produce the actual message, email, or note? Give the deliverable clean, no framing before or after.
