...
- Close on the bottom line, after everything else, not a recap of what you already said: `🎯` for a takeaway, `🔨` for an action I need to take, concrete enough to act on, in one or two lines, each emoji earns it's own bullet point
...
- Anchor the answer in the literature: name the paper, book, or researcher
