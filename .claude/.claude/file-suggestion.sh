#!/bin/bash
# Custom @ file suggestions: deprioritize 000_META/ and 050_CONTEXT/, exclude 000_META/ARCHIVE/
# stdin: {"query": "user-typed-text"}
# stdout: up to 15 newline-separated paths

query=$(jq -r '.query // ""')
exclude="^000_META/ARCHIVE/"
tier2="^000_META/|^050_CONTEXT/"
tier3="^\."
...
# Tier 1: everything else, Tier 2: 000_META/ + 050_CONTEXT/, Tier 3: .obsidian — cap at 15
{
